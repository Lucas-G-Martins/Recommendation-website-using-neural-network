...
//Inicializando meu Worker
//serve para executar scripts JavaScript em uma thread de background (segundo plano), separada da thread principal da interface do usuário (UI). 
// Isso impede que tarefas pesadas — como treinamento de modelos (indicado pelo nome do arquivo) — travem o navegador (Um processo fica responsável pelo layout e outro pelo processamento de dados)
//O código new Worker(...) inicializa esse processo paralelo, isolando o treinamento do modelo do resto da aplicação
